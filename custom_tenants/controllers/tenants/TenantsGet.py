...
from process.tenants.TenantsGet import TenantsGet
...
def lambda_handler(event, context):
    ...
    valid, code = tenant_object.tenants_get_validate_payload(payload)
    tenant_get_process = TenantsGet(tenant_object, time_zone)
