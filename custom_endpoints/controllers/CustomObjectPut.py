...
from custom_endpoint_utils import check_entity, get_entity_id, get_entity_name
from models.CustomObject import CustomObjectModel
from process.ObjectPut import ObjectUpdate
...
def lambda_handler(event, context):
    ...
    custom_create_process = ObjectUpdate(custom_object, payload, path_params, object_id)
